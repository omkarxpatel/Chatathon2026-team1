...
def render_how() -> None:
    ...
    steps = [
        ...
        (3, "A second pass asks which direction they are moving",
         "The same model, re-run on what we knew at 13 earlier dates, turns one number into a "
         "curve. Customers whose risk is climbing the way it climbed for people who left show "
         f"up under Drifting before they ever reach high risk — {len(early_warning)} of them on "
         "this run."),
        (4, "Cheap checks run before anything expensive does",
        ...
        (5, "The AI agent investigates whoever is left",
        ...
        (6, "Safety checks run on whatever it proposed",
